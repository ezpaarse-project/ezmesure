...
/**
 * @typedef {import('../../.prisma/client.mjs').Prisma.RepositoryCreateInput} RepositoryCreateInput
 * @typedef {import('../../.prisma/client.mjs').Prisma.RepositoryWhereInput} RepositoryWhereInput
*/
...
exports.createOne = async (ctx) => {
  ...
  if (body?.institutionId) {
    data.institutions = { connect: { id: body?.institutionId } };
  }

  const repositoriesService = new RepositoriesService();

  try {
    repository = await repositoriesService.create({ data });
  } catch (e) {
