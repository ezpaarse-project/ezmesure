...
const dashboardTemplates = require('./dashboard-templates');
const dashboardCollections = require('./dashboard-collections');
...
app.use(dashboardTemplates.prefix('/dashboard-templates').middleware());
app.use(dashboardCollections.prefix('/dashboard-collections').middleware());
