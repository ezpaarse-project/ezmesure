...
/** @typedef {import('../.prisma/client.mts').SpacePermission} SpacePermission */
/** @typedef {import('../.prisma/client.mts').Prisma.SpacePermissionUpdateArgs} SpacePermissionUpdateArgs */
/** @typedef {import('../.prisma/client.mts').Prisma.SpacePermissionUpsertArgs} SpacePermissionUpsertArgs */
/** @typedef {import('../.prisma/client.mts').Prisma.SpacePermissionCountArgs} SpacePermissionCountArgs */
/** @typedef {import('../.prisma/client.mts').Prisma.SpacePermissionFindUniqueArgs} SpacePermissionFindUniqueArgs */
/** @typedef {import('../.prisma/client.mts').Prisma.SpacePermissionFindManyArgs} SpacePermissionFindManyArgs */
/** @typedef {import('../.prisma/client.mts').Prisma.SpacePermissionCreateArgs} SpacePermissionCreateArgs */
/** @typedef {import('../.prisma/client.mts').Prisma.SpacePermissionDeleteArgs} SpacePermissionDeleteArgs */
