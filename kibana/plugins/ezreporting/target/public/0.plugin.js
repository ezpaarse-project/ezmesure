...
function setCapabilities(capa) {
  exports.capabilities = capabilities = capa[_common.PLUGIN_ID] || {};
}
...
class EzreportingApp extends _react.Component {
  ...
  render() {
    ...
    if (_reporting.capabilities.create) {
      createBtn = /*#__PURE__*/_react.default.createElement(_eui.EuiButton, {
        fill: true,
    ...
    return /*#__PURE__*/_react.default.createElement(_reactRouterDom.BrowserRouter, {
      ...
      defaultMessage: "{name}",
      values: {
        name: `${_common.PLUGIN_NAME} ${this.props.applicationName}`
      }
    })))), /*#__PURE__*/_react.default.createElement(_eui.EuiPageContentHeaderSection, null, createBtn)), /*#__PURE__*/_react.default.createElement(_eui.EuiPageContentBody, null, /*#__PURE__*/_react.default.createElement(_table.EzreportingTable, {
      tasks: tasks,
      dashboards: dashboards,
      frequencies: frequencies,
