  ...
  <section class="pa-0 ma-0">
    <v-container fluid>
      <v-layout
        ...
        justify-center
        fill-height
        class="text-center main-cover"
        :style="`padding-top: ${padding}px;`"
      >
        <v-flex xs12 md6>
          <img
            class="logo"
            :width="$vuetify.breakpoint.name === 'xs' ? '70%' : ''"
            alt="ezMESURE"
            src="/images/logo-ezMESURE-slogan.png"
          >
        </v-flex>
        <v-flex xs12 md6>
          <img
        ...
        <v-flex xs12 style="background-color: #eeeeee;">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 200">
            <path
              fill="#9c27b0"
              d="M 0 198 C 485.5 198 485.5 110 971 110 L 971 110 L 971 0 L 0 0 Z"
              stroke-width="0"
            />
            <path
              fill="#9c27b0"
              d="M 970 110 C 1445 110 1445 0 1920 0 L 1920 0 L 1920 0 L 970 0 Z"
              stroke-width="0"
            />
          </svg>
        </v-flex>
      ...
      >
        <v-flex xs12>
          <h4
            class="text-h5 text-xl-h4 grey--text text--darken-2 text-center mb-5"
        ...
        <v-flex v-for="(feature, i) in features" :key="i" d-flex shrink>
          ...
          <v-card class="text-center ma-3" light max-width="350px" height="300px">
            <v-img
              :alt="feature.title"
              :aspect-ratio="2.3"
              :src="feature.src"
      ...
      >
        ...
        <v-flex v-for="logo in logos" :key="logo.name" d-flex shrink>
          <v-card class="text-center ma-3 pa-5" width="250px" min-height="100px">
