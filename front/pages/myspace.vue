  ...
  <v-container>
    <template v-if="user">
      ...
      <v-tabs v-model="activeTab" show-arrows grow dark>
        <v-tab to="#tab-profile" router>Profil</v-tab>
        <v-tab to="#tab-files" router>Mes dépôts</v-tab>
        <v-tab to="#tab-kibana" router>Identifiants Kibana</v-tab>
        <v-tab to="#tab-token" router>Token d'authentification</v-tab>
      </v-tabs>
